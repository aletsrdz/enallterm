...
<div class="ficha-terminologica-form">
    ...
    <?= $form->field($model, 'termino_meta')->widget(TinyMce::className(), [
        'options' => ['rows' => 6],
        'language' => 'es',
        'clientOptions' => [
            'plugins' => [
    ...
    <?= $form->field($model, 'fuente_origen')->textarea(['rows' => 3]) ?>

    <?= $form->field($model, 'fuente_meta')->textarea(['rows' => 3]) ?>

    <?= $form->field($model, 'contexto_origen')->textarea(['rows' => 3]) ?>

    <?= $form->field($model, 'contexto_meta')->textarea(['rows' => 3]) ?>
